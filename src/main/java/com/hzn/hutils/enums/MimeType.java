...
public enum MimeType {
	...
	IMAGE_PNG ("image/png", new byte[]{(byte) 0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A}, "png"),
	...
	IMAGE_WEBP ("image/webp", new byte[]{0x52, 0x49, 0x46, 0x46, 0x57, 0x45, 0x42, 0x50}, "webp"), // "RIFF" + "WEBP"
	...
	APPLICATION_MSWORD ("application/msword", new byte[]{(byte) 0xD0, (byte) 0xCF, 0x11, (byte) 0xE0, (byte) 0xA1, (byte) 0xB1, 0x1A, (byte) 0xE1}, "doc"),
	APPLICATION_EXCEL ("application/vnd.ms-excel", new byte[]{(byte) 0xD0, (byte) 0xCF, 0x11, (byte) 0xE0, (byte) 0xA1, (byte) 0xB1, 0x1A, (byte) 0xE1}, "xls"),
	APPLICATION_POWERPOINT ("application/vnd.ms-powerpoint", new byte[]{(byte) 0xD0, (byte) 0xCF, 0x11, (byte) 0xE0, (byte) 0xA1, (byte) 0xB1, 0x1A, (byte) 0xE1}, "ppt"),
	APPLICATION_OPENXML_WORD ("application/vnd.openxmlformats-officedocument.wordprocessingml.document", new byte[]{0x50, 0x4B, 0x03, 0x04}, "docx"),
	APPLICATION_OPENXML_EXCEL ("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", new byte[]{0x50, 0x4B, 0x03, 0x04}, "xlsx"),
	APPLICATION_OPENXML_PRESENTATION ("application/vnd.openxmlformats-officedocument.presentationml.presentation", new byte[]{0x50, 0x4B, 0x03, 0x04}, "pptx"),
	...
	VIDEO_AVI ("video/avi", new byte[]{0x52, 0x49, 0x46, 0x46, 0x41, 0x56, 0x49, 0x20}, "avi"), // "RIFF" + "AVI "
